...
- Sprachansagen auf Englisch in Vorbereitung und Pausen (nächste Übung, Seitenwechsel, letzte Runde) bei fertigen und eigenen Workouts – **standardmäßig aus**, weil die Sprachausgabe des Handys Musik anderer Apps (Spotify) anhält; einschaltbar auf dem Deckblatt und in den Einstellungen
